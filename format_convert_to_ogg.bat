...
echo.
echo ==========================================
echo Pressor Format Conversion: OGG
echo ==========================================
echo.
...
echo.
echo Starting Pressor Format Conversion Mode to OGG...
echo.
%PYTHON% pressor.py --input "%INPUTDIR%" --output "%OUTPUTDIR%" --format-conversion --target-format ogg --structured-output --benchmark
